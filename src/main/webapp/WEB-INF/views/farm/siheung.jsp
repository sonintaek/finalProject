...
<div class="swiper">
	...
	<!-- Slides -->
		<div class="swiper-slide"><img src="${pageContext.request.contextPath}/resources/images/siSon1.jpg"></div>
		<div class="swiper-slide"><img src="${pageContext.request.contextPath}/resources/images/siSon2.jpg"></div>
		<div class="swiper-slide"><img src="${pageContext.request.contextPath}/resources/images/siSon3.jpg"></div>
		<div class="swiper-slide"><img src="${pageContext.request.contextPath}/resources/images/siSon4.jpg"></div>
		<div class="swiper-slide"><img src="${pageContext.request.contextPath}/resources/images/siSon5.jpg"></div>
...
<div class="product">
	<div class="box">
		<div class="top-box">
			<div>
				...
				손씨네농장에서 매주 월,수,금 텃밭의 상태를 카톡으로 알려드립니다.
			</div>
			<div>
	...
	<div class="box">
		...
		저희 농장에서는 C1, C2, C3, C4에서 농사를 경작하실 수 있는 구역을 제공하고 있습니다. <br>
